  ...
  <div class="dashboard" data-x="dashboard" data-x-toggle="-is-sidebar-open">
    <div class="dashboard__sidebar bg-white scroll-bar-1">
      ...
      <div class="sidebar -dashboard">
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="pro_logout.php" class="d-flex items-center text-15 lh-1 fw-500">
          ...
          <div class="col-xl-12 col-md-6">
            <div class="py-30 px-30 rounded-4 bg-white shadow-3">
              <div class="d-flex justify-between items-center">
                ...
                <div>
                  <div style="border-radius: 10px !important; cursor: pointer;" onclick="location.href='pro_products.php'" class=" px-4 py-4 text-underline text-center text-14 fw-500 bg-white text-dark-1 border-4 border-dark-1 ">Ver todos los pedidos</div>
                </div>
              </div>
              ...
              <div class="overflow-scroll scroll-bar-1 pt-30">
                <table class="table-2 col-12">
                  ...
                  <tbody class="text-center">
                    ...
                    <?php
                    $productos_query = "SELECT DISTINCT * FROM Producto JOIN Caracteristica ON producto.idProducto = caracteristica.idProducto WHERE emailVen = '$user' ORDER BY producto.idProducto";
                    $result = consultar("localhost", "root", "", $productos_query);
                    echo '<script>console.log("Mensaje desde PHP")</script>';

                    while ($reg = mysqli_fetch_array($result)) :
                      $nombre = $reg['nombre'];
                      $precio = $reg['precio'];
                      $caracteristicas = $reg['color'].' '.$reg['talla'];
                      $stock = $reg['stock'];
                      ...
                      <tr>
                        ...
                        <td><?php echo $estado ? 'Activo' : 'Inactivo'; ?></td>
                      </tr>
                    <?php endwhile; ?>
                  </tbody>
                </table>
