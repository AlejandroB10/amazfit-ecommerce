          ...
          <div class="col-xl-6 col-lg-7 col-md-9">
            <div class="px-50 py-50 sm:px-20 sm:py-20 bg-white shadow-2 rounded-xl">
              <div class="row y-gap-20">
                <div class="col-12">
                  <h1 class="text-22 fw-500">Acceso para Vendedores</h1>
                </div>
                ...
                <div class="col-12">
                  ...
                  <div onclick="loginVen()" class="button py-15 -dark-1 bg-blue-1 text-white rounded-xl">
