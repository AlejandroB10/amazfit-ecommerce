      ...
      <div class="dashboard__content bg-light-2">
        <div class="row y-gap-20 justify-between items-end pb-30 lg:pb-20 md:pb-16">
          <div class="col-auto">
            ...
            <h1 class="text-30 lh-14 fw-600">Bienvenido/a Alejandro</h1>
              ...
              <div class="d-flex justify-between items-center">
                ...
                <div>
                  <div style="border-radius: 10px !important; cursor: pointer;"
                          class=" px-4 py-4 text-underline text-center text-14 fw-500 bg-white text-dark-1 border-4 border-dark-1 ">Ver todos los pedidos</div>
                </div>
              </div>
                ...
                <table class="table-2 col-12">
                  ...
                  <tbody class="text-center">
                    ...
                    <tr>
                      ...
                      <td class="fw-500">$130</td>
                      <td class="d-flex justify-center">
                        <div class="rounded-100 py-4 text-center col-6 text-14 fw-500 bg-red-3 text-red-2">Rejected
                        </div>
                      </td>
                      <td>04/04/2022<br>08:16</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="fw-500">$130</td>
                      <td class="d-flex justify-center">
                        <div class="rounded-100 py-4 text-center col-6 text-14 fw-500 bg-blue-1-05 text-blue-1">
                          Confirmed</div>
                      </td>
                      <td>04/04/2022<br>08:16</td>
                      <td>
