        ...
        <div class="py-30 px-30 rounded-4 bg-white shadow-3">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-2">Añadir dirección</button>
              </div>
                ...
                <div class="col-xl-12">
                  <div class="row x-gap-20 y-gap-20">
                    ...
                    <div class="col-12">
                      ...
                      <div class="form-input ">
                        <input type="text" required>
                        <label class="lh-1 text-16 text-light-1">Dirección 2</label>
                      </div>
