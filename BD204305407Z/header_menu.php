    ...
    <div class="menu js-navList">
        <ul class="menu__nav text-white -is-active">
            ...
            <li class="menu-item-has-children">
                <a data-barba href="">
                    <span class="mr-10 fw-500 text-dark-1">Nutrición</span>
            ...
            <li class="menu-item-has-children">
                <a data-barba href="">
                    <span class="mr-10 fw-500 text-dark-1">Hombre</span>
                    <i class="icon icon-chevron-sm-down"></i>
                </a>
            ...
            <li class="menu-item-has-children">
                <a data-barba href="">
                    <span class="mr-10 fw-500 text-dark-1">Mujer</span>
                    <i class="icon icon-chevron-sm-down"></i>
                </a>
                ...
                <ul class="subnav">
                    ...
                    <li><a href=" categorias.php?nomCat=sudadera">Sudaderas</a></li>
            ...
            <li class="menu-item-has-children">
                <a data-barba href="">
                    <span class="mr-10 fw-500 text-dark-1">Accesorios</span>
                    <i class="icon icon-chevron-sm-down"></i>
                </a>
